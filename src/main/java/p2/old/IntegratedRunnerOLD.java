...
import p2.clustering.ExtDBSCANClustering;
import p2.clustering.ExtData;
import p2.clustering.ExtKMeansClustering;
import p2.util.DataLoaderUtil;

public class IntegratedRunnerOLD {
	...
	public static void main(String[] args) {
		...
		IntegratedRunnerOLD runner = new IntegratedRunnerOLD(filename);
	 ...
	 */
	public IntegratedRunnerOLD(String file) {
